...
import * as BookInput from './BookInput.graphql';
  ...
  return (
    <div>
      <form onSubmit={onSubmit}>
        ...
        <label>
          description: <input type="text" name="description" value={description} onChange={(e) => setDescription(e.target.value)} required />
        </label>
